...
- moving rozum ahoy function to main functions file
...
- removed "Powered by Wordpress & Rozum" from footer, because let's face it: we all delete this anyway.
...
- removed default "Rozum" text in footer if you don't have a menu
...
- added rozum body class depending on what browser
...
- added post formats to rozum.php core
...
- fixed error in rozum.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the rozum file so it's easier to see what's being
	called.
